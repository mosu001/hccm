 ...
 */
public class HCCMEntityDelayControlledOutput extends LinkedComponent implements LineEntity {
	...
	public HCCMEntityDelayControlledOutput() {}
	...
	private static class RemoveDisplayEntityTarget extends EntityTarget<HCCMEntityDelayControlledOutput> {
		private final DisplayEntity delayedEnt;

		RemoveDisplayEntityTarget(HCCMEntityDelayControlledOutput d, DisplayEntity e) {
