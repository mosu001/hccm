 ...
 * 
 */
public class ExtTestTrigger extends Trigger {
    ...
    public void executeLogic(List<ActiveEntity> ents, double simTime) {
        ...
        if ((simTime % 86400) > 43200 && (simTime % 86400) < 45000 && !((WaitActivity)this.getJaamSimModel().getNamedEntity("WaitToTest")).getEntities().isEmpty()) {
            ...
            ((ProcessActivity)this.getJaamSimModel().getNamedEntity("TestLunchBreak")).start(participants);
        }
        else {
